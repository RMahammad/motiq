...
export const categories: Category[] = [
  ...
  { id: "cursor", label: "Cursor & pointer", blurb: "Magnetic, particle, and reveal effects driven by the pointer." },
  { id: "media", label: "Media & galleries", blurb: "Galleries, carousels, scrubbers, and image effects with real physics." },
  { id: "scroll", label: "Scroll animations", blurb: "Scroll-driven storytelling: zoom heroes, parallax, wipes, and velocity physics." },
...
export const catalog: CatalogItem[] = [
  ...
  },
  {
    ...
    slug: "loom-draft",
    description:
      "A living woven fabric: a shuttle of light races the loom laying luminous weft row by row, an iridescent violet→cyan→pink sheen rolls across the finished cloth, and warp threads sway. Animated canvas, committed-dark, reduced-motion-safe.",
    category: "backgrounds",
    subcategory: "Backgrounds",
    status: "beta",
    access: "free",
    dependencies: [],
    registryDependencies: [`${product.registryNamespace}/utils`, `${product.registryNamespace}/primitives`],
    tags: ["background", "loom", "weave", "textile", "jacquard", "svg", "ambient"],
    registryItem: "loom-draft",
    documentationPath: "/components/loom-draft",
    dateAdded: ADDED,
    featured: false,
    supportsDarkMode: true,
    supportsReducedMotion: true,
  ...
  {
    id: "copperplate-hatch",
    name: "Copperplate Hatch",
    slug: "copperplate-hatch",
    description:
      "An engraved plate lit from within: candle-gold light waves radiate from a focal point and ignite each burin stroke as they pass, making the whole plate glint in sequence. Animated canvas, committed-dark, reduced-motion-safe.",
    category: "backgrounds",
    subcategory: "Backgrounds",
    status: "beta",
    access: "free",
    dependencies: [],
    registryDependencies: [`${product.registryNamespace}/utils`, `${product.registryNamespace}/primitives`],
    tags: ["background", "engraving", "hatch", "crosshatch", "print", "svg", "ambient"],
    registryItem: "copperplate-hatch",
    documentationPath: "/components/copperplate-hatch",
    dateAdded: ADDED,
    featured: false,
    supportsDarkMode: true,
    supportsReducedMotion: true,
  ...
  },
  {
    ...
    slug: "chart-recorder",
    description:
      "Five spectrum lanes written live by glowing pens - data packets stream the traces, hot ink cools into a settled trail, and event markers bloom rings as the pens cross them. Animated canvas, committed-dark, reduced-motion-safe.",
    category: "backgrounds",
    subcategory: "Backgrounds",
    status: "beta",
    access: "free",
    dependencies: [],
    registryDependencies: [`${product.registryNamespace}/utils`, `${product.registryNamespace}/primitives`],
    tags: ["background", "chart", "recorder", "instrument", "lanes", "svg", "ambient"],
    registryItem: "chart-recorder",
    documentationPath: "/components/chart-recorder",
    dateAdded: ADDED,
    featured: false,
    supportsDarkMode: true,
    supportsReducedMotion: true,
  ...
  {
    id: "riso-registration",
    name: "Riso Registration",
    slug: "riso-registration",
    description:
      "Two halftone ink plates hunting for register: pink and blue screen-blended grids drift apart then snap into alignment as a press roller sweeps through. Animated canvas, committed-dark, reduced-motion-safe.",
    category: "backgrounds",
    subcategory: "Backgrounds",
    status: "beta",
    access: "free",
    dependencies: [],
    registryDependencies: [`${product.registryNamespace}/utils`, `${product.registryNamespace}/primitives`],
    tags: ["background", "riso", "halftone", "registration", "print", "svg", "ambient"],
    registryItem: "riso-registration",
    documentationPath: "/components/riso-registration",
    dateAdded: ADDED,
    featured: false,
    supportsDarkMode: true,
    supportsReducedMotion: true,
  ...
  },
  {
    ...
    slug: "core-strata",
    description:
      "A survey scanner reading the deep record: three parallax strata layers drift while a luminous beam sweeps the core, igniting amber marker seams as it finds them. Animated canvas, committed-dark, reduced-motion-safe.",
    category: "backgrounds",
    subcategory: "Backgrounds",
    status: "beta",
    access: "free",
    dependencies: [],
    registryDependencies: [`${product.registryNamespace}/utils`, `${product.registryNamespace}/primitives`],
    tags: ["background", "strata", "geology", "sediment", "core sample", "scroll", "svg", "ambient"],
    registryItem: "core-strata",
    documentationPath: "/components/core-strata",
    dateAdded: ADDED,
    featured: false,
    supportsDarkMode: true,
    supportsReducedMotion: true,
...
> = {
  ...
  cursor: { family: "creative", size: "wide", span: 8 },
  media: { family: "creative", size: "wide", span: 8 },
  scroll: { family: "editorial", size: "full", span: 12 },
...
const PRESENTATION_OVERRIDES: Record<string, Partial<Presentation>> = {
  ...
  "loom-draft": { previewSize: "ambient", stageFamily: "creative", cardSpan: 12 },
  "copperplate-hatch": { previewSize: "ambient", stageFamily: "creative", cardSpan: 12 },
  "chart-recorder": { previewSize: "ambient", stageFamily: "console", cardSpan: 12 },
  "riso-registration": { previewSize: "ambient", stageFamily: "creative", cardSpan: 12 },
  "core-strata": { previewSize: "ambient", stageFamily: "data", cardSpan: 12 },
