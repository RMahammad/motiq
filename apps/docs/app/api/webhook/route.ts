...
//     Header: x-motionkit-signature: <hex HMAC-SHA256 of the raw body>
//                                    (or "sha256=<hex>")
//
...
const SIGNATURE_HEADER = "x-motionkit-signature";

export async function POST(req: Request) {
  const secret = process.env.MOTIONKIT_WEBHOOK_SECRET ?? null;
