...
export function ApiRequestInspectorPreview() {
  ...
  return (
    <div className="w-full max-w-[820px]">
      ...
      {/* Working controls -------------------------------------------------- */}
      <div className="mt-3 flex flex-wrap items-center gap-1.5 rounded-xl [border:1px_solid_var(--color-border)] bg-[var(--color-bg-secondary)] px-3 py-2.5" role="group" aria-label="Console controls">
