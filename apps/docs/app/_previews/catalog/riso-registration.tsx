...
// Lab literal: the riso CTA gets a `color:#fff` override.
...
/**
 * Compact catalog adapter. Renders the REAL RisoRegistrationBackground
 * FULL-BLEED with a concise hero overlaid on its readable safe area. No demo
 * controls or inner frame (the detail page owns the interactive playground).
 * Deterministic; sized to the ambient stage.
 */
export function RisoRegistrationCatalogPreview() {
  return (
    ...
    >
      <div className="flex h-full flex-col justify-center px-7 py-6 sm:px-9">
        ...
        <p className="mt-2.5 max-w-[38ch] text-[13.5px] leading-relaxed" style={heroBodyStyle}>
          Two halftone ink plates drift toward and past alignment on independent cycles - so headline, copy, and CTA stay crisp on top.
        </p>
...
export default RisoRegistrationCatalogPreview;
