...
export function CopperplateHatchPreview() {
      ...
      <div className="relative w-full overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg)] shadow-[var(--shadow-md)]">
        ...
        >
          ...
          <div className="relative flex min-h-[440px] flex-col justify-center px-7 py-10 sm:px-10">
            ...
            >
              Crosshatched ink layers accumulate tone around your focal point and thin to blank paper behind your
              headline - like a hand-worked engraving plate.
            </p>
          ...
          {showSafe ? (
            <div
              ...
              style={{
                ...
                height: `${SAFE.h * 100}%`,
                borderColor: "#eab365",
                background: "rgba(234,179,101,0.06)",
              }}
            >
              <span className="absolute -top-2.5 left-3 px-1.5 text-[11px] font-medium" style={{ background: "#0a0b10", color: "#eab365" }}>
                safe area
              </span>
            </div>
          ) : null}
...
export default CopperplateHatchPreview;
