...
// configuring components.json (with the ${MOTIQ_TOKEN} placeholder — NEVER a
...
//
// SECRET-SAFE: every example uses the ${MOTIQ_TOKEN} placeholder. The only
...
function previewTermsApproved(): boolean {
  ...
  return process.env.MOTIQ_PREVIEW_TERMS_APPROVED === "1";
}
