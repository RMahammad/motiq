...
- **Dependencies:** motion + `@motiq/utils` + `@motiq/primitives`; registryDependencies: live-presence-stack, activity-stream, approval-workflow, comment-thread, typing-and-presence. No new deps.
