...
- **Dependencies:** motion + `@motionkit/utils` + `@motionkit/primitives` (useDisclosure, useCopy, formatTimestamp, streamItemVariants, useReducedMotion). No new deps. Optimistic state handled internally.
